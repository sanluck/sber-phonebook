...
public class PhonebookApplication {
    ...
    CommandLineRunner init(EmployeeRepository employeeRepository, DepartmentRepository departmentRepository) {
        return args -> {
            ...
            employeeRepository.save(createEmployee("Лукьянов", "Александр", "Алексеевич", MALE, new Date(), blockT, "Main Engeneer"));
            employeeRepository.save(createEmployee("Верёвкин", "Максим", "Николаевич", MALE, new Date(), sberbank, "Chief Engeneer"));
            employeeRepository.save(createEmployee("Голубев", "Александр", "Васильевич", MALE, new Date(), blockT, "Lead Engeneer"));
        };
    }
}
